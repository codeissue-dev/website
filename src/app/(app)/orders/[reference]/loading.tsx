export default function OrderDetailLoading() {
  return (
    <div role="status" aria-live="polite" className="flex flex-col gap-4">
      ...
      <div className="h-4 w-32 animate-pulse rounded-control bg-surface-muted motion-reduce:animate-none" />
      <div className="h-9 w-full max-w-md animate-pulse rounded-control bg-surface-muted motion-reduce:animate-none" />
