...
test('uses Next Link for the internal account route', async () => {
  ...
  assert.match(headerSource, /<Link\s+href="\/account"/);
  assert.doesNotMatch(headerSource, /<a\s+href="\/account"/);
});
